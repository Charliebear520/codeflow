        ...
        >
          ...
          <div className="clerk-action-buttons">
            ...
            >
              ...
              >
                <path
                  d="M13.3 8.85C13.4 8.6 13.45 8.3 13.45 8C13.45 7.7 13.4 7.4 13.3 7.15L14.4 6.25C14.5 6.15 14.5 6.05 14.45 5.9L13.45 4.1C13.4 3.95 13.25 3.9 13.1 3.95L11.8 4.5C11.45 4.2 11.1 4 10.65 3.85L10.4 2.5C10.4 2.35 10.25 2.2 10.1 2.2H8.1C7.95 2.2 7.8 2.35 7.8 2.5L7.55 3.85C7.15 4 6.75 4.25 6.4 4.5L5.1 3.95C4.95 3.9 4.8 3.95 4.75 4.1L3.75 5.9C3.7 6.05 3.7 6.2 3.8 6.25L4.9 7.15C4.8 7.4 4.75 7.7 4.75 8C4.75 8.3 4.8 8.6 4.9 8.85L3.8 9.75C3.7 9.85 3.7 10 3.75 10.1L4.75 11.9C4.8 12.05 4.95 12.1 5.1 12.05L6.4 11.5C6.75 11.8 7.1 12 7.55 12.15L7.8 13.5C7.85 13.65 7.95 13.8 8.1 13.8H10.1C10.25 13.8 10.4 13.65 10.4 13.5L10.65 12.15C11.05 12 11.45 11.75 11.8 11.5L13.1 12.05C13.25 12.1 13.4 12.05 13.45 11.9L14.45 10.1C14.5 9.95 14.5 9.85 14.4 9.75L13.3 8.85ZM9.1 10C8 10 7.1 9.1 7.1 8C7.1 6.9 8 6 9.1 6C10.2 6 11.1 6.9 11.1 8C11.1 9.1 10.2 10 9.1 10Z"
                  fill="currentColor"
                />
              </svg>
              <span>應用設置</span>
